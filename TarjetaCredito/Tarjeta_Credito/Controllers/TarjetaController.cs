...
namespace Tarjeta_Credito.Controllers
{
    [Route("[controller]")]
    [ApiController]
    public class TarjetaController : ControllerBase
    {
        ...
        public async Task<IActionResult> Get()
        {
            try
            {
                var listTarjetas = await _context.Tarjeta_Credito.ToListAsync();
        ...
        public async Task<IActionResult>  Delete(int id)
        {
            try
            {
                var tarjeta = await _context.Tarjeta_Credito.FindAsync(id);
                if(tarjeta == null)
                {
                    return NotFound();
                }
                ...
                {
                    _context.Tarjeta_Credito.Remove(tarjeta);
                    await _context.SaveChangesAsync();
